...
import Jumpman from '../../img/sneakerCard/jordan/jumpman/JumpmanTwo.jpg';
...
<div className="buyTwoContainer">
  ...
  <Stars />
    ...
    The presented model is made in white. 
    The sneakers are decorated with many stitched lines, as well as black 
    inserts on the front and back. On the tongue is the brand's signature logo, 
    which is made in red. The thickened sole with an Air insert allows you to get
    instant cushioning of the foot, and the rubberized sole gives good traction on the surface.
    </p>
